...
@component('layouts.app', ['seoTitle' => 'About Us'])
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200" dir="ltr">
                    <h1 class="text-3xl font-bold mb-8 text-center text-gray-800">About Us</h1>
                    ...
                    <div class="prose max-w-none text-gray-700 leading-relaxed text-center">
                        ...
                        @else
                            <div class="mb-8">
                                <h2 class="text-xl font-bold mb-4 text-indigo-700">Contact Channels</h2>
                                ...
                                <div class="flex flex-col items-center justify-center space-y-4">
                                    ...
                                    <div class="flex flex-col items-center mt-4">
                                        <span class="font-bold text-gray-900 mb-2">Address:</span>
                                        <p class="text-center max-w-md">
                                            Tehran - Abouzar - Shahid Hojatollah Shahrabi St - South Parastar St - Baharan Block 7 Entrance 2 - No 2.0
                                        </p>
                                    </div>
                                </div>
                            </div>
