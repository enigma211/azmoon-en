    ...
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        @else
            ...
            <div class="text-center py-16">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">No resource found</h3>
                <p class="text-gray-500">Currently, there are no PDF or video files available in this section.</p>
            </div>
        @endif
    </div>
</div>
