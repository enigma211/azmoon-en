    ...
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-12">
            @if($category->type === 'video')
                <h1 class="text-2xl font-bold text-gray-900 mb-4">Educational Videos for {{ $examType->title }}</h1>
            @elseif($category->type === 'document')
                <h1 class="text-2xl font-bold text-gray-900 mb-4">Educational Pamphlets for {{ $examType->title }}</h1>
            @else
        ...
        @if($posts->isEmpty())
            <div class="text-center py-12">
                ...
                <p class="text-gray-600 text-lg">No content added yet.</p>
            </div>
        @endif
