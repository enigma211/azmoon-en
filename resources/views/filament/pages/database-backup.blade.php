    ...
    <div class="space-y-6">
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-blue-900 dark:text-blue-100">About Backups</h3>
                    <p class="text-sm text-blue-800 dark:text-blue-200 mt-1">
                        You can back up your database using this section. Backup files are saved in SQL format.
                        It is recommended to back up your database regularly.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Backup List</h2>
            </div>
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <h3 class="mt-4 text-sm font-medium text-gray-900 dark:text-white">No backups available</h3>
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">To create the first backup, click on the "Create New Backup" button.</p>
                </div>
            @endif
        </div>
    </div>
