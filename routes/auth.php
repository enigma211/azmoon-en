...
Route::middleware('guest')->group(function () {
    ...
    Route::get('forgot-password/code', [PasswordResetLinkController::class, 'showCodeVerifyForm'])
    ...
    // Step 3: Set new password (no token in URL, email is taken from session)
